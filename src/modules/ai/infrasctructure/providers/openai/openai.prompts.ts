...
const courseSchema = {
  ...
  properties: {
    course: {
      ...
      required: ['title', 'description', 'category', 'level', 'duration', 'targetAudience'],
    },
    lessons: {
      type: 'array',
      items: {
...
export function buildCoursePrompt(input: CreateCouseInput): OpenAI.Chat.Completions.ChatCompletionMessageParam[] {
  return [
    {
      role: 'system',
